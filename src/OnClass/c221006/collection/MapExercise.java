...
//        // 정보 입력, 앞의 입력값은 key!! 뒤의 입력값은 value!!
//        map.put("가나다", "라마바");
//        map.put("사아자", "차카타");
//
...
//        System.out.println(map.get("사아자"));
        ...
        map.put("고다니", "	https://github.com/kimkimj/create-repo1");
        ...
        map.put("배강	", "ttps://github.com/ReadnThink/Like_lion.git");
        ...
        map.put("한단	", "ttps://github.com/Kim-Ji-Yeong/Java-exercise");
        ...
        map.put("전율	", "ttps://github.com/joypeb/java-project-push-test");
        ...
        map.put("황솔	", "ttps://github.com/hyunsik96/git-exercise-java-push");
        ...
        map.put("허선	", "ttps://github.com/Changbum97/like-lion-java");
        ...
        map.put("노휘	", "ttps://github.com/hakjun1/intelij-git-exercise03");
        ...
        map.put("전담	", "ttps://github.com/sandee-han/java-project-push-exercise");
